...
class NewItemInNewDetail extends Component {
  ...
  render() {
    ...
    return (
      <div className="col-lg-4 col-md-4 col-sm-6 mt-40" style={{ margin: '15px 0 0 0' }}>
        ...
        <div className="single-product-wrapNew" onClick={(id) => this.getInfoNew(newItem.newsId)}>
          ...
          <div className="product_desc">
            <div className="product_desc_info" >
              <h4 className="product_name" style={{ textDecoration: 'none', padding: '0px 0px 0px 0px' }}>
                {newItem.title}
              </h4>
            </div>
          </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(NewItemInNewDetail))
